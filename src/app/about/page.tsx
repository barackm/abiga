          ...
          <div className='grid md:grid-cols-2 gap-8 items-center'>
            ...
            <div className='space-y-4' data-aos='fade-left'>
              <p className='text-gray-600 leading-relaxed'>
                Abigaël Mapendo Buyana est née le 22 février 2009 à Goma. Elle était une jeune fille rayonnante, pleine
                de vie et d&apos;amour pour sa famille et ses amis.
              </p>
              <p className='text-gray-600 leading-relaxed'>
                Élève brillante et passionnée, elle excellait particulièrement en mathématiques et adorait la musique.
                Son rêve était de devenir médecin pour aider les autres.
              </p>
              <p className='text-gray-600 leading-relaxed'>
